            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  FittedBox(fit: BoxFit.scaleDown, child: Text(cardTitle, style: TextStyle(color: cardColor, fontWeight: FontWeight.w900, fontSize: 18, letterSpacing: 1.2), textAlign: TextAlign.center)),
                  const SizedBox(height: 4),
                  FittedBox(fit: BoxFit.scaleDown, child: Text(seriesScore.toUpperCase(), style: const TextStyle(color: Colors.amberAccent, fontSize: 11, fontWeight: FontWeight.bold, letterSpacing: 1))),
                  const SizedBox(height: 8),
                  Container(height: 1, color: Colors.white24),
                  const SizedBox(height: 8),
                  FittedBox(fit: BoxFit.scaleDown, child: Text(playerTitle, style: const TextStyle(color: Colors.white54, fontSize: 13, letterSpacing: 2))),
                  const SizedBox(height: 4),
                  FittedBox(fit: BoxFit.scaleDown, child: Text(scoreText, style: const TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold))),
